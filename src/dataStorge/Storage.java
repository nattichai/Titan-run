...
public class Storage {
	...
	static {
		...
		for (int i = 0; i < player.nImage; ++i) {
			player.images[i] = new Image(ClassLoader.getSystemResource("images/character/character1_" + i + ".png").toString());
		}
		player.width = 120;
		player.height = 200;
		...
		for (int i = 0; i < pikachu.nImage; ++i) {
			pikachu.images[i] = new Image(ClassLoader.getSystemResource("images/character/character2_" + i + ".png").toString());
		}
		pikachu.width = 200;
		pikachu.height = 130;
		...
		for (int i = 0; i < spearman.nImage; ++i) {
			spearman.images[i] = new Image(ClassLoader.getSystemResource("images/character/character3_" + i + ".png").toString());
		}
		spearman.width = 300;
		spearman.height = 300;
		...
		for (int i = 0; i < sorcerer.nImage; ++i) {
			sorcerer.images[i] = new Image(ClassLoader.getSystemResource("images/character/character4_" + i + ".png").toString());
		}
		sorcerer.width = 300;
		sorcerer.height = 300;
		...
		for (int i = 0; i < shaman.nImage; ++i) {
			shaman.images[i] = new Image(ClassLoader.getSystemResource("images/character/character5_" + i + ".png").toString());
		}
		shaman.width = 300;
		shaman.height = 300;
