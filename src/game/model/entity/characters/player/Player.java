package game.model.entity.characters.player;
...
import game.model.entity.gui.GUIImage;
...
import game.model.property.Slidable;
...
public class Player extends Characters implements Slidable {
	...
	public void useShield() {
		...
		if (mana <= 0) {
			...
			Handler.keyReleased(new KeyEvent(null, null, KeyEvent.KEY_RELEASED, null, "SPACE", KeyCode.SPACE, false,
					false, false, false));
		}
	}
	...
	public void die() {
		...
		Timeline timeline = new Timeline(new KeyFrame(Duration.millis(Logic.LOOP_TIME), e -> {
			positionY += 10;
		...
		timeline.setCycleCount((int) Logic.FPS / 2);
		timeline.play();
		timeline.setOnFinished(e -> {
			hp = 0.00001;
