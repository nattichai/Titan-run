...
public class GroundObstacle extends Obstacle {
	...
	public GroundObstacle(double x, double y, double w, double h) {
		...
		if (height < 200) {
			Jelly jelly = new Jelly(1000, -50, Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1050, -75, Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1150, -100, Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1250, -75, Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1300, -50,Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
		} else {
			Jelly jelly = new Jelly(900, -80,Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1000, -120, Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1150, -160,Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1300, -120, Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
			jelly = new Jelly(1400, -80,Jelly.JELLY_WIDTH, Main.SCREEN_HEIGHT);
			Container.getContainer().add(jelly);
		}
