...
public class GUIDamage extends GUIText {
	private static final Stop[] stops = new Stop[] { new Stop(0, Color.rgb(0xf4, 0xd8, 0)),
			new Stop(1, Color.rgb(0xe5, 0x34, 0x29)) };
	private static final LinearGradient FONT_COLOR = new LinearGradient(0, 1, 0, 0, true, CycleMethod.NO_CYCLE, stops);
